...
<section>
    <div class="container mt-5 mb-5 font-roboto">
        <div class="d-flex">
            <a class="btn btn-danger mb-2 mr-auto" href="index.php?manage=bill&ac=list">Quay lại</a>
        </div>
        <div class="mt-3">
                            ...
                            <div class="col-md-9">
                                <?php
                                    if($detailInfo['status'] == 1){
                                        echo 'Đang giao hàng';
                                    }elseif($detailInfo['status'] == 2){
                                        echo 'Đã thanh toán';
                                    }elseif($detailInfo['status'] == 3){
                                        echo 'Hủy đơn';
                                    }else{
                                        echo 'Chờ thanh toán';
                                    }
                            ...
                            <tr>
                                ...
                                <?php
                                    if(isset($detailInfo['address'])){
                                        $address = strtolower($detailInfo['address']);
